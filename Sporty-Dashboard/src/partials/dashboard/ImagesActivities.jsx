...
import './ImagesActivities.css';



function ImagesActivities() {
  return (
    <div className='activity-container bg-white dark:bg-slate-800 shadow-lg rounded-sm border border-slate-200 dark:border-slate-700'> 
        <h2 id='ActivitiesHead'>Activities On Board</h2> 
...
export default ImagesActivities